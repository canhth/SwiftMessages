...
+ (NSString *)localizedString:(NSString *)key {
    ...
    NSBundle *tmp = [NSBundle bundleWithPath:[[[NSBundle bundleForClass:self] resourcePath] stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.bundle/", @"DoraemonKit"]]];
